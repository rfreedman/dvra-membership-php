...
(function () {
  ...
  function autofitPaymentsReportColumns() {
    ...
    for (i = 0; i < n; i++) {
      max = 0;
      sel =
        "thead tr:first-child > *:nth-child(" +
        (i + 1) +
        "), tbody tr > *:nth-child(" +
        (i + 1) +
        ")";
